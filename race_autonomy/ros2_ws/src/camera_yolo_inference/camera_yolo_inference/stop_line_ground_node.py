...
class StopLineGroundNode(Node):
    def __init__(self):
        ...
        defaults={"max_detection_age_sec":.35,"camera_x_m":.245,"camera_y_m":.004,"camera_z_m":.845,"camera_mount_roll_deg":0.,"camera_mount_pitch_deg":-5.,"camera_mount_yaw_deg":0.,"box_vertical_ratio":.5,"maximum_distance_m":30.}
