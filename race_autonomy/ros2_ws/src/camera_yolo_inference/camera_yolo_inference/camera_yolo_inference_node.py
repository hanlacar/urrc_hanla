...
class CameraYoloInferenceNode(Node):
    def __init__(self,backend=None):
        ...
        defaults={"segmentation_model_path":"","class_manifest_path":"","device":"cpu","input_width":640,"input_height":480,"inference_fps":60.0,"detections_image_fps":60.0,"confidence_threshold":.25,"mask_threshold":.5,"road_mask_threshold":.30,"lane_mask_threshold":.45,"road_confidence_threshold":.25,"lane_confidence_threshold":.50,"lane_minimum_component_area":80,"lane_maximum_horizontal_ratio":4.0,"lane_minimum_horizontal_width":80,"navigation_bottom_exclusion_ratio":0.,"max_image_age_sec":.2,"max_inference_latency_ms":40.,"input_image_topic":"/camera/image_raw","input_camera_info_topic":"/camera/camera_info","expected_image_width":640,"expected_image_height":480,"stop_detected_topic":"/perception/stop_detected","stop_confidence_threshold":.25,"traffic20_confidence_threshold":.25,"object_confirmation_frames":3,"publish_diagnostics":True,"require_cuda":False,"camera_x_m":.41,"camera_y_m":0.,"camera_z_m":.85,"camera_mount_roll_deg":0.,"camera_mount_pitch_deg":-5.,"camera_mount_yaw_deg":0.,"path_overlay_timeout_sec":.5,"bev_forward_min_m":.3,"bev_forward_max_m":6.,"bev_normal_lateral_m":1.2,"bev_turn_lateral_m":1.5,"bev_s_curve_lateral_m":1.5,"bev_intersection_lateral_m":1.,"min_lookahead_m":1.,"max_lookahead_m":2.,"lookahead_speed_gain":.5}
