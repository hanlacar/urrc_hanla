...
def generate_launch_description():
    share=Path(get_package_share_directory("camera_yolo_inference"));config=str(share/"config"/"yolo_inference.yaml");manifest=str(share/"config"/"class_manifest.yaml");model=str(share/"models"/"hanla_yolo11n_seg_best.engine")
