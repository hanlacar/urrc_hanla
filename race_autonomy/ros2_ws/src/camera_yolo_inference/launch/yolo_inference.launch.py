...
ARGUMENTS=(("segmentation_model_path",""),("class_manifest_path",""),("device","cuda:0"),("require_cuda","true"),("input_width","640"),("input_height","480"),("inference_fps","60.0"),("detections_image_fps","60.0"),("confidence_threshold","0.25"),("mask_threshold","0.5"),("navigation_bottom_exclusion_ratio","0.0"),("max_image_age_sec","0.2"),("max_inference_latency_ms","100.0"),("input_image_topic","/camera/image_raw"),("input_camera_info_topic","/camera/camera_info"),("expected_image_width","640"),("expected_image_height","480"),("publish_diagnostics","true"),("use_sim_time","false"))
