...
def generate_launch_description():
    ...
    defaults={"segmentation_model_path":str(yolo/"models"/"hanla_yolo11n_seg_best.engine"),"class_manifest_path":str(yolo/"config"/"class_manifest.yaml"),"device":"cuda:0","require_cuda":"true","input_width":"640","input_height":"480","inference_fps":"40.0","detections_image_fps":"30.0","confidence_threshold":"0.25","mask_threshold":"0.5","max_image_age_sec":"0.2","max_inference_latency_ms":"40.0","input_image_topic":"/camera/image_raw","input_camera_info_topic":"/camera/camera_info","expected_image_width":"640","expected_image_height":"480","publish_diagnostics":"true","use_sim_time":"false","launch_rqt":"true","launch_camera":"false","color_width":"640","color_height":"480","color_fps":"60"}
