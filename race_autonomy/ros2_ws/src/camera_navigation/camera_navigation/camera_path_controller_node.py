...
class CameraPathController(Node):
    def __init__(self):
        ...
        defaults={"wheelbase_m":.73,"min_lookahead_m":1.,"max_lookahead_m":2.,"lookahead_speed_gain":.5,"max_steering_deg":27.,"steering_rate_limit_deg_s":20.,"normal_speed_mps":.526,"turn_speed_mps":.229,"single_boundary_speed_mps":.526,"road_only_speed_mps":.229,"max_lateral_accel_mps2":1.,"accel_limit_mps2":.5,"decel_limit_mps2":1.}
