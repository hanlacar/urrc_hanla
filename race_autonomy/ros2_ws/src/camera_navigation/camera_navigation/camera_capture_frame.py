...
def main(args=None):
    ...
    stamp=msg.header.stamp.sec+msg.header.stamp.nanosec*1e-9;metadata={"image_topic":"/camera/image_raw","timestamp":stamp,"frame_id":msg.header.frame_id,"width":msg.width,"height":msg.height,"encoding":msg.encoding,"png_color_contract":"lossless PNG; OpenCV BGR storage representing original RGB colors","camera_info":camera_info_dict(node.info),"camera_extrinsic":{"camera_x_m":.245,"camera_y_m":.004,"camera_z_m":.845,"camera_mount_roll_deg":0.,"camera_mount_pitch_deg":-5.,"camera_mount_yaw_deg":0.},"capture_time_utc":datetime.now(timezone.utc).isoformat()}
