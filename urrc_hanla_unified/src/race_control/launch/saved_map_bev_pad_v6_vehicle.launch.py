...
def generate_launch_description():
    ...
    default_model = str(yolo_share /
                        "models" / "hanla_competition_11class_best_rtx5060_fp16.engine")
    default_manifest = str(yolo_share /
                           "config" / "class_manifest.yaml")
    default_python = str(yolo_share.parents[3] / ".yolo_runtime" / "bin" / "python")
    return LaunchDescription([
        ...
        DeclareLaunchArgument("python_executable", default_value=default_python),
