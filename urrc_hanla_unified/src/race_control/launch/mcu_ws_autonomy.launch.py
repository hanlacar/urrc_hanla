"""Run camera perception and path outputs using external MCU speed feedback.
...
def generate_launch_description():
    ...
    autonomy = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "vehicle_speed_kph_topic": "/mcu/speed_kph",
    ...
    return LaunchDescription([
        ...
        LogInfo(msg=(
            "CAMERA OUTPUT MODE: publishing /autonomy/observation and /autonomy/path. "
