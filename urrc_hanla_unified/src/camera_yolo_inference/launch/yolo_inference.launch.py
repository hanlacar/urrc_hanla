...
ARGUMENTS=(("segmentation_model_path",""),("class_manifest_path",""),("device","cuda:0"),("require_cuda","true"),("input_width","640"),("input_height","480"),("inference_fps","40.0"),("detections_image_fps","30.0"),("confidence_threshold","0.25"),("mask_threshold","0.5"),("navigation_bottom_exclusion_ratio","0.0"),("max_image_age_sec","0.2"),("max_inference_latency_ms","100.0"),("input_image_topic","/camera/image_raw"),("input_camera_info_topic","/camera/camera_info"),("expected_image_width","640"),("expected_image_height","480"),("publish_diagnostics","true"),("use_sim_time","false"))
def generate_launch_description():
    share=Path(get_package_share_directory("camera_yolo_inference"));config=str(share/"config"/"yolo_inference.yaml");manifest=str(share/"config"/"class_manifest.yaml");model=str(share/"models"/"hanla_competition_11class_best_rtx5060_fp16.engine")
    runtime_python=str(share.parents[3]/".yolo_runtime"/"bin"/"python")
    ...
    declarations.append(DeclareLaunchArgument("python_executable", default_value=runtime_python))
    ...
    return LaunchDescription(declarations+[
        ...
        Node(package="camera_yolo_inference",executable="stop_line_depth_node",
             ...
             parameters=[{"depth_topic":"/camera/camera/aligned_depth_to_color/image_raw",
