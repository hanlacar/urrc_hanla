...
def generate_launch_description():
    ...
    display_route = str(share / 'routes' / 'all_b_sim.csv')
    ...
    return LaunchDescription([
        ...
        Node(package='mission_manager', executable='dr_odom_sim',
             name='dr_odom_sim', output='screen', parameters=[{
                 ...
                 'initial_x': -0.307809, 'initial_y': -3.443486,
                 'initial_yaw_deg': 155.990329036}]),
        Node(package='mission_manager', executable='dr_all_a_sim_inputs',
             name='dr_all_b_sim_inputs', output='screen', parameters=[{
                 't_branch': 'T_B', 'v_branch': 'V_B',
                 'end_branch': 'END_AB'}]),
        Node(package='mission_manager', executable='dr_real_segmented_follower',
             name='dr_real_segmented_follower', output='screen', parameters=[{
                 'network_path': network, 'start_segment': 'START_B',
        ...
        Node(package='rviz2', executable='rviz2', name='dr_all_b_rviz',
